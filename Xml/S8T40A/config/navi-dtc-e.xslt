...
<xsl:variable name="wrtsct">
	...
	<xsl:if test="descendant::servinfo/@dtccode!=''">
...
<xsl:template match="servcat[descendant::servinfo/@dtccode!='']">
	<xsl:value-of select="$newline"/>
...
<!-- servinfotype -->
<!-- not required for Dtc index
<xsl:template match="servinfotype[servinfo/@dtccode!='']">
	<xsl:value-of select="$newline"/>
...
<xsl:template match="servinfo[@dtccode!='']">
	<xsl:value-of select="$newline"/>
...
<xsl:element name="a">
	...
	<xsl:element name="div">
		<xsl:attribute name="class">sie_dtc</xsl:attribute>
